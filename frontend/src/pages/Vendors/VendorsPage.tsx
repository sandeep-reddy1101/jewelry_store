    ...
    <div className="space-y-6">
      ...
      <Card padding="lg" className="bg-gradient-to-br from-white via-blue-50/30 to-indigo-50/30 border-2 border-white/40 shadow-glass">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-display font-bold mb-2 text-gray-800 text-contrast">Vendor Management ✨</h1>
            <p className="text-gray-700 text-lg font-medium">
              Manage your supplier network efficiently. {vendors.length} vendors in your network.
            </p>
          </div>
          <div className="hidden lg:block">
            <BuildingOfficeIcon className="h-16 w-16 text-primary-500 animate-float" />
          </div>
        </div>
      </Card>
      ...
      <Card padding="lg" className="bg-gradient-to-br from-white via-blue-50/30 to-indigo-50/30 border-2 border-white/40 shadow-glass">
        <div className="flex flex-col lg:flex-row lg:items-end gap-6">
          ...
          <div className="flex-1 min-w-0">
            <label className="block text-sm font-medium text-gray-700 mb-3">Search Vendors</label>
            <div className="relative group">
              ...
              <input
                ...
                placeholder="Search by name, email, phone, GST number..."
              />
            </div>
          </div>
            ...
            <div className="min-w-0">
              ...
              <div className="relative group">
                <select
                  ...
                  className="custom-select w-full sm:w-32 h-12 px-4 pr-10 border border-gray-300 rounded-xl focus:ring-0 focus:border-primary-400 focus:shadow-lg focus:shadow-primary-100 bg-white hover:border-gray-400 transition-all duration-200 font-medium text-gray-900 appearance-none cursor-pointer"
                >
